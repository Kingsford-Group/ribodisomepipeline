...
STAR --genomeDir ${contaminant_idx} --readFilesIn ${riboseq_fq} --outFileNamePrefix ${oriboprefix} --outStd BAM_Unsorted --outReadsUnmapped Fastx --outSAMmode NoQS "--readFilesCommand zcat <" ${common_params}  --outFilterMatchNmin 20 > /dev/null 
#============================================
